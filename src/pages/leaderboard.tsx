...
const LeaderboardExplanationSection = () => {
  return (
    <article className="relative hidden h-fit w-96 shrink-0 gap-5 rounded-2xl border-2 border-gray-300 border-opacity-20 p-6 xl:flex">
      <div className="flex flex-col gap-5">
        <h2 className="font-bold uppercase text-gray-500">
          Apa itu papan skor?
        </h2>
        <p className="font-bold text-gray-300">Belajar. Raih XP. Bersaing.</p>
        <p className="text-gray-400 font-normal">
          Raih XP melalui pelajaran, dan bersaing dengan pelajar lain di papan skor mingguan
        </p>
      </div>
          ...
          {!leaderboardIsUnlocked && (
            <>
              ...
              <p className="text-center text-lg text-gray-300">
                ...
                {lessonsRemainingToUnlockLeaderboard === 1 ? "" : "s"} untuk mulai berkompetisi
              </p>
              <Link
