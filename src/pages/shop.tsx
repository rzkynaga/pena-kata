...
const Shop: NextPage = () => {
  ...
  return (
    <div>
      <TopBar />
      <LeftBar selectedTab="Toko" />
      <div className="flex justify-center gap-3 pt-14 sm:p-6 sm:pt-10 md:ml-24 lg:ml-64 lg:gap-12">
        <div className="px-4 pb-20">
          <div className="py-7">
            <h2 className="mb-5 text-2xl text-gray-200 font-bold">Power-up</h2>
            <div className="flex border-t-2 border-gray-300 py-5">
              <StreakFreezeSvg className="shrink-0" />
              <section className="flex flex-col gap-3">
                <h3 className="text-lg text-gray-200 font-bold">Pembeku Runtutan</h3>
                <p className="text-sm text-gray-300">
                  Pembeku Runtunan mencegah runtunanmu hilang meskipun tidak beraktivitas selama sehari penuh.
                </p>
                <div className="w-fit rounded-full bg-gray-500 bg-opacity-30 px-3 py-1 text-sm font-bold uppercase text-gray-400">
                  {streakFreezes} / 2 Aktif
                </div>
                <button
                  className="flex w-fit items-center gap-1 rounded-2xl border-2 border-opacity-20 border-gray-300 bg-gray-300 bg-opacity-5 px-4 py-2 text-sm font-bold uppercase text-gray-300"
                  disabled
                >
                  Tukar: <EmptyGemSvg /> 10
                </button>
              </section>
            </div>
            <div className="flex border-t-2 border-gray-300 py-5">
              ...
              <section className="flex flex-col gap-3">
                <h3 className="text-lg font-bold text-gray-200">Ganda atau Hampa</h3>
                <p className="text-sm text-gray-300">
                Gandakan taruhan 50 permatamu dengan mempertahankan runtunan selama 7 hari.
                </p>
                <button
                  className="flex w-fit items-center gap-1 rounded-2xl border-2 border-opacity-20 border-gray-300 bg-gray-300 bg-opacity-5 px-4 py-2 text-sm font-bold uppercase text-gray-300"
                  disabled
          ...
          <div className="py-7">
            <h2 className="mb-5 text-2xl text-gray-200 font-bold">Merch</h2>
            <div className="flex border-t-2 border-gray-300 py-5">
              <DuoPlushieSvg className="h-32 w-32 shrink-0 p-4" />
              <section className="flex flex-col gap-3">
                <h3 className="text-lg text-gray-200 font-bold">Duo Plushie</h3>
                <p className="text-sm text-gray-300">
                  {`Rayakan ulang tahun Duolingo yang ke-10 dengan boneka Duo Plushie yang baru!`}
                </p>
